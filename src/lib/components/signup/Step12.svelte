        ...
        <div class="text-sm text-gray-700 flex flex-col gap-2">
            ...
            <ul class="list-disc list-inside">
                <li>
                    ...
                    <a href="/privacy-policy" class="text-blue-600 underline hover:text-blue-800" target="_blank">Privacy Policy</a>.
                </li>
                <li>
                    You have read and understood our 
                    <a href="/terms-of-use" class="text-blue-600 underline hover:text-blue-800" target="_blank">Terms of Use</a>.
                </li>
                <li>
