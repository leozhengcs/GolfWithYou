...
{#if showNav}
<nav
	class="bg-gradient-to-b from-sky to-sky-background absolute top-0 z-50 flex h-[100px] w-full flex-row items-center justify-between p-5"
	...
	<div class="flex flex-row gap-10">
		<Tooltip text="View Profile">
			<button
				...
				class="flex aspect-square w-12 cursor-pointer items-end justify-center overflow-clip rounded-full bg-white"
			>
				<img
