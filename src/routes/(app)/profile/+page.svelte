...
<div class="grid w-full flex-1 grid-cols-[250px_auto] gap-5 px-52">
	...
	{#if tab == 'profile'}
		<section
			class="flex h-full w-full flex-col gap-5 rounded-lg border-1 border-gray-300 p-10 py-5"
		>
...
<form method="POST" bind:this={formElement} enctype="multipart/form-data">
	...
	<!-- <input type='file' class='hidden' name="avatarFile" bind:value={imageFile}/> -->
</form>
